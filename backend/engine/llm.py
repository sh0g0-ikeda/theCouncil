...
- concretize: 具体的な歴史事例・制度名・数字を1つ挙げて論じる（例：「1981年のオシラク攻撃では〜」）
...
_PHASE_DIRECTIVES: dict[int, str] = {
    1: "【フェーズ1・定義期】このテーマを何の基準で判断するかを宣言せよ（例：国際法・安全保障リアリズム・倫理）。その基準に基づく自分の結論を一言で断言し、歴史的根拠を1つ添えよ。",
    2: "【フェーズ2・対立期】攻撃・具体化に集中。必ず歴史例か数字で根拠を示せ。抽象論のみは失格。",
