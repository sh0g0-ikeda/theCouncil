...
async def generate_debate_script(
    ...
    system_msg = (
        ...
        "そのキャラが『この議題』に対してどの立場を取るかを思想的に推論してassigned_sideを決定せよ。\n"
        "手順:\n"
        "  1. 各エージェントのnon_negotiableを読む。議題に肯定的な立場か否定的な立場かを判断する。\n"
        "  2. worldviewを読む。議題の前提・価値観と合致するか対立するかを確認する。\n"
        "  3. 以上から support / oppose / neutral を決定する。\n"
        "制約:\n"
        "  - インデックス順・順番で機械的にsupportとopposeを交互に割り当てることは絶対禁止\n"
        "  - 全員が同じsideになる場合は、最も思想的に近い者1名だけをneutralに変更せよ\n"
